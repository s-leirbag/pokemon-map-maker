...
function PlayerWalkState:checkForEncounter()
    ...
    if self.level.secondLayer.tiles[y] and self.level.secondLayer.tiles[y][x] and self.level.secondLayer.tiles[y][x].name == 'tall-grass' then --and math.random(10) == 1 then
